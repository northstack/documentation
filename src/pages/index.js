										...
										<Card>
											<Link to="/getting-started/">
												<Card.Body>
													...
													<Card.Text>
														Just getting started? Follow our guide to get up and running
														with NorthStack in minutes!
													</Card.Text>
												</Card.Body>
											</Link>
										</Card>
										...
										<Card>
											<Link to="/frameworks/">
												<Card.Body>
													...
													<Card.Text>
														Browse the officially supported frameworks to build your app
														faster than ever with minimal maintenance.
													</Card.Text>
												</Card.Body>
											</Link>
										</Card>
										...
										<Card>
											<Link to="/frameworks/gatsby/">
												<Card.Body>
													...
													<Card.Text>
														Generate incredibly fast static sites with React.
													</Card.Text>
												</Card.Body>
											</Link>
										</Card>
										<Card>
											<Link to="/frameworks/jekyll/">
												<Card.Body>
													...
													<Card.Text>
														Create static sites with minimal code required.
													</Card.Text>
												</Card.Body>
											</Link>
										</Card>
